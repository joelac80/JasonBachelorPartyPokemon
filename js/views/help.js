  ...
  const GROUPS = [
    ...
    },
    {
      ...
      items: [
        ...
        { r: "gyms", e: "🏟", t: "Gym Circuit", d: "Battle the 16 canon Gym Leaders of Johto & Kanto (Falkner → BLUE) in EVEN matches — you bring exactly as many Pokémon as the leader runs, and their team is hidden until each comes out of its ball. Everyone can earn every badge; sweep all 16 for CHAMPION; a loss costs 3 sips. All 8 Johto badges unlock the 👑 POKÉMON LEAGUE." },
        { r: "league", e: "👑", t: "Pokémon League", d: "The cinematic climb: Victory Road gate (8 Johto badges to pass), the Elite Four chambers in order, Champion LANCE, the Hall of Fame with every champion’s winning team (challenge any enshrined team in a ⚔ Battle of Fame — exhibition only)… and beating Lance wakes something on Mt. Silver." },
