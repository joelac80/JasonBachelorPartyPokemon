...
(function () {
  ...
  const GROUPS = [
    ...
    },
    {
      title: "🎯 Games to play",
      items: [
        { r: "safari", e: "🔴", t: "Pokédex Safari", d: "Pick a catcher, then earn boosts by doing dares/berries/rallies (chicken out = drink, and it might bolt!). Add a helper for a 2v2, or nail the Master Ball dare for a guaranteed catch. ✨ 1-in-16 encounters are SHINY — different colors, DOUBLE payout, and their OWN Pokédex. 🧭 THE GEN LADDER: your wild starts at Gen 1 (#1–151) and BATTLES open the rest — all 8 Johto badges spill Gen 2 into the grass, then each Champion you beat in The Journey unlocks the next generation (LANCE→Gen 3, STEVEN→Gen 4… LEON→Gen 9, all the way to #1025). No dex completion required — it's about the climb. You won't re-meet something you've already caught, but a shiny counts separately — catch a normal Totodile and a shiny one can still turn up. Flip the Regular ⇄ ✨ Shiny tabs in your dex. ~30% of catches drop a 🍓 Sitrus Berry (auto-heals in duels), tap any caught mon for nicknames — and every so often, with the room synced, the sky breaks and a 🌩 ROAMING LEGENDARY appears: everyone can go catch their own. Everyone builds their own dex — no one-of-one." },
