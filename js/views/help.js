  ...
  const GROUPS = [
    ...
    },
    {
      ...
      items: [
        ...
        { r: "feed", e: "📸", t: "Snapshots (the feed)", d: "The weekend's photo feed — every 📸 photo moment lands here with who posted it and WHEN. React ❤️😂🔥👏🥳 and comment as your trainer; photos also show on the Weekend Log and the Poster." },
