  ...
  const GROUPS = [
    ...
    },
    {
      ...
      items: [
        ...
        { r: "badges", e: "🏅", t: "Gym Circuit & Badges", d: "Battle the 16 canon Gym Leaders of Johto & Kanto (Falkner → BLUE) in EVEN matches — you bring exactly as many Pokémon as the leader runs, and their team is hidden until each comes out of its ball. Everyone can earn every badge; sweep all 16 for CHAMPION; a loss costs 3 sips. The 8 hand-awarded party badges (with powers) live below." },
