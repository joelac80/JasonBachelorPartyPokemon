  ...
  const GROUPS = [
    ...
    },
    {
      ...
      items: [
        ...
        { r: "gyms", e: "🏟", t: "Gym Circuit", d: "Battle 32 canon Gym Leaders across FOUR regions — Johto & Kanto (Falkner → BLUE), then Hoenn (Roxanne → Juan) and Sinnoh (Roark → Volkner) — in EVEN matches: you bring exactly as many Pokémon as the leader runs, and their team is hidden until each comes out of its ball. Leaders bring their grown-up REMATCH squads (fully evolved). Everyone can earn every badge; a loss costs 3 sips. Sweep all 16 Johto & Kanto for CHAMPION. All 8 Johto badges open the 👑 POKÉMON LEAGUE — and the 8 Hoenn / 8 Sinnoh badges unlock those regions' Elite Fours later on." },
        ...
        { r: null, e: "🗺", t: "The full road", d: "The whole ladder: ① the 8 JOHTO badges (Falkner → Clair) open Victory Road → ② the Elite Four fall IN ORDER (Will, Koga, Bruno, Karen) → ③ Champion LANCE — Hall of Fame, and Mt. Silver appears → ④ the 8 KANTO badges (Brock → Blue) make 16 → ⑤ RED faces you at the summit. Then it keeps going: ⑥ earn the 8 HOENN gym badges → the Hoenn Elite Four (Sidney → Drake) → Champion STEVEN → ⑦ earn the 8 SINNOH gym badges → the Sinnoh Elite Four (Aaron → Lucian) → ⑧ and, at the very end, the final battle… 🎹." },
    ...
    },
    {
      ...
      items: [
        ...
        { r: null, e: "🏟", t: "Gym Crusher", d: "Most gym badges across the 32-leader Gym Circuit — sweep all 16 Johto & Kanto and the trophy becomes CHAMPION." },
