  ...
  const GROUPS = [
    ...
    },
    {
      ...
      items: [
        ...
        { r: "badges", e: "🏅", t: "Gym Badges", d: "EARN the 8 gym badges by beating the AI Gym Leaders in real battles (Brock, Misty, Clair…) — win takes the badge, even off another trainer; a loss costs 3 sips. Badges can still be hand-awarded, and the Live Trophies show alongside." },
