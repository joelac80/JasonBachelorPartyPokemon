...
(function () {
  ...
  const GROUPS = [
    ...
    },
    {
      title: "🎯 Games to play",
      items: [
        { r: "safari", e: "🔴", t: "Pokédex Safari", d: "Pick a catcher, then earn boosts by doing dares/berries/rallies (chicken out = drink, and it might bolt!). Add a helper for a 2v2, or nail the Master Ball dare for a guaranteed catch. ✨ 1-in-16 encounters are SHINY — different colors, DOUBLE payout, and their OWN Pokédex. 🧭 THE GEN LADDER: your wild starts at Gen 1 (#1–151) and BATTLES open the rest — beat Champion BLUE in Kanto to spill Gen 2 into the grass, then each Champion you beat in The Journey unlocks the next generation (LANCE→Gen 3, STEVEN→Gen 4… LEON→Gen 9, all the way to #1025). No dex completion required — it's about the climb. You won't re-meet something you've already caught, but a shiny counts separately — catch a normal Totodile and a shiny one can still turn up. Flip the Regular ⇄ ✨ Shiny tabs in your dex. ~30% of catches drop a 🍓 Sitrus Berry (auto-heals in duels), tap any caught mon for nicknames — and every so often, with the room synced, the sky breaks and a 🌩 ROAMING LEGENDARY appears: everyone can go catch their own. Everyone builds their own dex — no one-of-one." },
        ...
        { r: "battle", e: "⚔️", t: "Battle Arena", d: "🎮 Pokémon Duel: real turn-based battles at Lv50. Singles bring a party of up to 6 (switch on faint or spend a turn to switch); Doubles put 2 Pokémon a side on the field at once — team up with a partner, or one trainer runs both. 🧪 Potion = 3 sips to heal 120 · 🍺 Liquid Courage = finish half your drink and UNLEASH a can’t-miss guaranteed crit that same turn. Sips are on the line: every KO = 2 sips, the losing side toasts 4. Singles wins claim the 🥇 Champion’s Belt — beat the holder to take it. And battle EXP is real: a Pokémon that lands 3 KOs ITSELF evolves after the battle (Eevee gets to choose) — except Kadabra, Machoke, Graveler and Haunter, who ONLY evolve by trade. 📣 Quick Call: tap who won a real-world event. Winners’ teams score either way. 📈 Singles duels move your Elo rating; veterans hit harder (+2% ATK per KO, up to +20%); 🍓 a Sitrus Berry auto-heals when a mon drops low; hot-seat duels offer an instant 🔁 rematch." },
        { r: "brackets", e: "🥊", t: "Party Brackets", d: "Run a tournament bracket — each matchup can launch the battle screen." },
        { r: "regions", e: "🗺", t: "The Journey", d: "The whole climb in one place, region by region (chronological, Gen 1 & 2 together): each region's GYMS → its ELITE FOUR → its CHAMPION. 68 canon leaders across nine regions in EVEN matches — you bring exactly as many Pokémon as the leader runs, teams hidden until each ball opens, and leaders bring fully-evolved rematch squads. Sweep all 16 Johto & Kanto for CHAMPION; each region's 8 badges unlock its Elite Four. Beyond the regions: the silent trainer RED on Mt. Silver, two 🎬 MOVIE LEGENDS (Mewtwo & the Collector, folded into Kanto & Johto), and the 🏆 CHAMPIONS CUP — a 16-legend bracket of every Elite Four & Champion. A loss costs 3 sips; a Champion win enshrines your team in the 🏛 Hall of Fame — challenge any enshrined team, or run the whole GAUNTLET." },
        { r: null, e: "🧭", t: "The full ladder", d: "Per region it's the same shape: ① the 8 gym badges → ② the Elite Four fall IN ORDER → ③ the Champion. Kanto & Johto is the flagship — 16 badges, Will→Karen, Champion LANCE, then RED on Mt. Silver — and every later region (Hoenn → Paldea) adds its own 8 gyms, Elite Four and Champion, ending with Top Champion GEETA. Pick any region from the tabs at the top of The Journey." },
